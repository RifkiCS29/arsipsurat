...
// Mengambil data dari tabel
                    $bulan=$_POST['bulan'];
                    $tahun=$_POST['tahun'];	
                    $sql1  		= "SELECT * FROM tb_suratkeluar WHERE MONTH(tanggalsurat_suratkeluar)='$bulan' AND YEAR(tanggalsurat_suratkeluar) = '$tahun' AND nama_bagian = '".$_SESSION['nama']."'";                        
                ...
                $nama_file = 'SURAT KELUAR BAGIAN '.$_SESSION['nama'].'-'.$bulan.'-'.$tahun;
