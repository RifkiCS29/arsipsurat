...
// Mengambil data dari tabel
                    $bulan=$_POST['bulan'];
                    $tahun=$_POST['tahun'];
                    $sql1		= "SELECT * FROM tb_suratmasuk WHERE (MONTH(tanggalmasuk_suratmasuk)='$bulan' AND YEAR(tanggalmasuk_suratmasuk) = '$tahun') AND (disposisi1 = '".$_SESSION['nama']."' || disposisi2 = '".$_SESSION['nama']."' || disposisi3 = '".$_SESSION['nama']."')" ;                        
                ...
                $nama_file = 'SURAT MASUK BAGIAN '.$_SESSION['nama'].'-'.$bulan.'-'.$tahun;
